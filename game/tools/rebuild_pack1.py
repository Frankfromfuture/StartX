...
NEW_CARDS = [
    ...
    ("p2_document",     "文书", "tool", "", "", "", 0, "", 15, 0),
    ("p2_contract",     "合同", "tool", "", "", "", 0, "", 20, ""),
    ("p2_grad",         "毕业生", "employee", "any", 1, 2, "", "", 6, ""),
    ("p2_admin_management", "行政管理", "tool", "", "", "", 1, "", 15, ""),
    ("p2_sales_course", "销售技巧课程", "tool", "", "", "", 2, "", 20, ""),
    ("p2_product_course", "产品技能课程", "tool", "", "", "", 2, "", 20, ""),
    ("p2_legal_admin_course", "法务行政课程", "tool", "", "", "", 2, "", 20, ""),
    ...
    ("p2_orderly_workstation", "井井有条的工位", "facility", "", "", "", 1, "", 30, ""),
]
...
NEW_RECIPES = [
    ...
    ("p2_specialist_package_product", "包装粗糙产品", "", 12,
     [("p2_product_specialist", 1, False), ("p1_wholesale", 1, False), ("cash", 1, True)], [("p1_package", 1)]),
    ("p1_make_rawprod", "做出粗糙产品", "any", 15,
     [("p1_wholesale", 1, False), ("cash", 1, True)], [("p1_rawprod", 1)]),
    ("p1_package_prod", "包装产品", "", 30,
     [("p1_rawprod", 1, True), ("p1_marketing", 1, True), ("cash", 1, True)], [("p1_package", 1)]),
