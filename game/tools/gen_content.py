...
# ======================================================== 基础资源
C("cash", "现金", "cash", value=0)
C("lead", "线索", "tool", value=1)
C("customer_list", "客户名单", "tool", value=2)
C("order", "订单", "tool", value=3)
C("bigdeal", "大单", "tool", value=8)
C("revenue", "营收", "tool", value=12)
C("doc", "资料", "tool", value=1)
C("code", "代码", "tool", value=2)
C("module", "模块", "tool", value=4)
C("prd", "技术方案", "tool", value=2)
C("product", "产品", "tool", value=8)
C("data", "数据", "tool", value=1)
C("insight", "洞察", "tool", value=3)
C("traffic", "流量", "tool", value=1)
C("user", "用户", "tool", value=2)
C("report", "报告", "tool", value=4)
C("contract", "合同", "tool", value=5)
C("proposal", "方案", "tool", value=0)
C("patent", "专利", "tool", value=0)
C("brand", "品牌", "tool", value=0)
C("license", "牌照", "tool", value=0)
C("training", "培训", "tool", value=1)
C("market_report", "行业报告", "tool", value=3)
C("equity", "股权", "tool", value=0)

# ======================================================== 资源节点（深耕对象）
C("customer_pool", "客户资源", "resource", maxUses=4)
C("expo_booth", "展会摊位", "resource", maxUses=3)
C("app_store", "应用商店", "resource", maxUses=5)
C("oss_repo", "开源代码库", "resource", maxUses=6)
C("hot_topic", "热点话题", "resource", maxUses=3)
C("data_source", "数据源", "resource", maxUses=5)
C("archive", "文档库", "resource", maxUses=5)
C("capital_market", "资本市场", "resource", maxUses=4)
C("overseas", "海外市场", "resource", maxUses=4)
C("talent_pool", "人才市场", "resource", maxUses=3)
C("university", "大学", "resource", maxUses=4)
C("research_bench", "研发台", "resource")
